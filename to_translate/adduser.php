...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	sql_query("INSERT INTO users (class, added, last_access, secret, username, passhash, notifs, emailnotifs, confirmed, email) VALUES({$classes['reg']},".time().", ".time().", $secret, ".sqlesc($username).", $passhash, '{$REL_CONFIG['default_notifs']}', '{$REL_CONFIG['default_emailnotifs']}', 1, $email)") or die(mysql_error());
	if (mysql_errno()==1062)
